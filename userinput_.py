...
def getvals():
    ...
    print(f"{namevalue.get(), phonevalue.get(), gendervalue.get(), paymentvalue.get(), emergencyvalue.get(), foodservicevalue.get()}")
    with open("records.txt", "a") as f:
        f.write(f"{namevalue.get(), phonevalue.get(), gendervalue.get(), paymentvalue.get(), emergencyvalue.get(), foodservicevalue.get()}")
